...
function ICodeThis() {
    ...
    function ShowMessage() {
        ...
        return (
            <div className={`${activeMsg[0]?.type === "Error" ? 'bg-rose-500' : 'bg-sky-500'} animate-left-out transition-colors duration-1000 w-[90%] h-[10%] rounded-md flex items-center`} id="container">
            ...
            <div className="h-full w-[10%]  flex items-center justify-end pr-2" id="close">
                <button className='hover:text-slate-200 transition-colors duration-300' onClick={() => handleClose()}>
      ...
      <div id="toggleDarkDiv" className="dark">
        <div id="bodyDiv" className="bg-slate-100 min-h-screen flex justify-center items-center">
            <div className='relative bg-blue-700 h-[80dvh] w-[80%] max:w-20 flex justify-center items-center rounded-lg shadow-xl drop-shadow-lg overflow-hidden'>
                {activeMsg[0]?.type !== null && hideCard === false && (
                    <ShowMessage />
                )}
