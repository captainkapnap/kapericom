    ...
    return (
        <div className='text-slate-300 flex flex-wrap w-[90%] justify-center items-center'>
            {listOfPages.map((event, index) => (
                <div className='bg-purple-700 hover:bg-cyan-600 hover:font-semibold rounded-xl text-center m-3 h-20 w-[25%] border-black border shadow-lg flex justify-center items-center'>
